...
Training script for 3D CNN on ADNI NIfTI data using PyHealth's Trainer,
with support for data splitting, augmentation, age incorporation, and TensorBoard logging.
'''
import os
import yaml
import time
